...
VALUES (NULL, 'kevin.m.bowersox@gmail.com', 'Kevin', 'Bowersox', '{noop}password', 'kbowersox', 'ROLE_ADMIN');
INSERT INTO AUTO_USER (autoUserId, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE)
VALUES (NULL, 'johndoe@gmail.com', 'John', 'Doe', '{noop}password', 'jodoe', 'ROLE_USER');
INSERT INTO AUTO_USER (autoUserId, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE)
VALUES (NULL, 'janedoe@gmail.com', 'Jane', 'Doe', '{noop}password', 'jadoe', 'ROLE_USER');
INSERT INTO AUTO_USER (autoUserId, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE)
VALUES (NULL, 'juniordoe@gmail.com', 'Junior', 'Doe', '{noop}password', 'jrdoe', 'ROLE_USER');
