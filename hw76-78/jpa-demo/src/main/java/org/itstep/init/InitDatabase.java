...
public class InitDatabase {
    ...
    public void init() {
        ...
        academyService.save(new Student("Маша", "Ефросинина",
                LocalDate.of(1986, 2, 12), groups.get(0)));        academyService.save(new Student("Маша", "Ефросинина",
                LocalDate.of(1986, 2, 12), groups.get(0)));        academyService.save(new Student("Маша", "Ефросинина",
                LocalDate.of(1986, 2, 12), groups.get(0)));        academyService.save(new Student("Маша", "Ефросинина",
                LocalDate.of(1986, 2, 12), groups.get(0)));        academyService.save(new Student("Маша", "Ефросинина",
                LocalDate.of(1986, 2, 12), groups.get(0)));        academyService.save(new Student("Маша", "Ефросинина",
        ...
        academyService.save(new Teacher(null, "Василий", "Петрович",
                List.of(groups.get(0), groups.get(1))));        academyService.save(new Teacher(null, "Василий", "Петрович",
                List.of(groups.get(0), groups.get(1))));        academyService.save(new Teacher(null, "Василий", "Петрович",
                List.of(groups.get(0), groups.get(1))));        academyService.save(new Teacher(null, "Василий", "Петрович",
                List.of(groups.get(0), groups.get(1))));        academyService.save(new Teacher(null, "Василий", "Петрович",
                List.of(groups.get(0), groups.get(1))));        academyService.save(new Teacher(null, "Василий", "Петрович",
