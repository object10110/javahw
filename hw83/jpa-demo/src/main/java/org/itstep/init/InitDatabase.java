...
public class InitDatabase {
    ...
    public InitDatabase(StudentService studentService, GroupService groupService, TeacherService teacherService, GroupMapper groupMapper, GroupRepository groupRepository,  TeacherMapper teacherMapper) {
...
//        groupRepository.saveAll(groupList);
        ...
        // Init students
        studentService.save(new StudentDto("student", "$2a$10$jevNVRIoZhOcfuos5WKilOCHVtwaUH/IIpl7YRdR1LVekpm9900JW", "Вася", "Пупкин",
                LocalDate.of(2001, 1, 1), 1));

/*        studentService.save(new StudentDto("Маша", "Ефросинина",
                LocalDate.of(1986, 2, 12), 1));*/

/*        Student student = new Student("student", "{noop}student", "ROLE_STUDENT", "Вася", "Пупкин",
                LocalDate.of(2001, 1, 1), groupList.get(1));
...
//        groupRepository.saveAll(groupList.stream().limit(2).collect(Collectors.toList()));
        ...
        //teacherDto = new TeacherDto(null, "Василий2", "Петрович2", null);
        //teacherService.save(teacherDto);
